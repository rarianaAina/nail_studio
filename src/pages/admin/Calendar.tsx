        ...
        <Card className="border-border/60 shadow-soft lg:col-span-2">
          <CardContent className="p-4 sm:p-6">
            ...
            <div className="mt-4 grid grid-cols-7 gap-1">
              {weekdays.map((d) => (
                <div key={d} className="py-2 text-center text-[10px] font-medium uppercase text-muted-foreground sm:text-xs">{d}</div>
              ))}
              {cells.map((d, i) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      {appts.length > 0 && (
                        <span className="text-[9px] font-medium text-primary sm:text-[10px]">{appts.length}</span>
                      )}
                    </div>
