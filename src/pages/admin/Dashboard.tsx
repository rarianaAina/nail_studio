...
export default function Dashboard() {
  ...
  const revenueChartData = revenueByMonth.map((d) => ({ mois: d.label, montant: d.value }));
            ...
            <Card className="border-border/60 shadow-soft">
              <CardContent className="p-5">
                <div className="flex items-start justify-between">
                  ...
                  <span className={`flex items-center gap-1 text-xs font-medium ${s.up ? 'text-emerald-600' : 'text-rose-600'}`}>
